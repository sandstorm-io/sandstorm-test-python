...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "rwyva77wj1pnj01cjdj2kvap7c059n9ephyyg5k4s5enh5yw9rxh",
  ...
  manifest = (
    ...
    appMarketingVersion = (defaultText = "0.0.11"),
    # Human-readable representation of appVersion. Should match the way you
    # identify versions of your app in documentation and marketing.

    actions = [
      # Define your "new document" handlers here.
      ( title = (defaultText = "New Test Set"),
        command = .myCommand,
        nounPhrase = (defaultText = "test page"),
    ...
    metadata = (
      ...
      website = "https://github.com/zarvox/sandstorm-test-python",
      # This should be the app's main website url.

      codeUrl = "https://github.com/zarvox/sandstorm-test-python",
      ...
      shortDescription = (defaultText = "integration tests"),
